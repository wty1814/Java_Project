...
public class BaskballFrame extends JFrame{
	
    public static void main(String args[]){

        Dimension dim = new Dimension(700, 500);  //단순 2차원값 입력을 위한 클래스

        JFrame bemf = new JFrame("농구 기록");
        ...
        JLabel kind_bklbl = new JLabel("종목 - 농구");
        kind_bklbl.setLocation(10,10);
        kind_bklbl.setSize(150,30);
        bemf.add(kind_bklbl);
		Font f2 = new Font("", Font.BOLD, 20); //("글자체", Font.글자스타일, 글자크기)
		kind_bklbl.setFont(f2);
